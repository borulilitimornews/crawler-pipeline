from get_seed_word import GetSeedWords
from get_seed_url import GetSeedUrl
...
class MainSeeder:
    ...
    def __init__(self) -> None:
        # Parameters
        self.target_language = 'tet'
        self.corpus_sample_ratio = 0.1
        self.lang_proba_threshold = 0.95
        self.n_seed_word_sample = 3

        get_seed_word = GetSeedWords(
            self.target_language, self.corpus_sample_ratio,
            self.lang_proba_threshold, self.n_seed_word_sample)
        ...
        self.get_url = GetSeedUrl(self.EXTENSION_TO_EXCLUDE,
